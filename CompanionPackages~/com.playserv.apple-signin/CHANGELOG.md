...
- Connected Apple ID-token credentials to `PlayServAuth.LoginExternalAsync`.
- Authorization-code-only credentials are no longer emitted as backend ID-token proofs.
...
- Aligned package and core SDK dependency versions with `0.3.3`.

## [0.3.2] - 2026-07-25

- Extracted Apple Sign In from `com.playserv.sdk` into a standalone UPM package.

...
namespace Playserv.Wrapper
{
    ...
    public static class PlayServServerRpc
    {
        ...
        {
            var localExecution = PlayServRuntimeHost.LocalExecution as Playserv.Server.IPlayServLocalExecution;
            if (localExecution == null)
                throw new System.InvalidOperationException("Server local execution module is not installed or enabled.");

...
namespace Playserv.Test.RPC2
{
    ...
    {
        // Deliberately invalid for analyzer: multiple constructors in an RPC class.
        public NotificationService()
        {
        }

        public NotificationService(int testValue)
        {
        }
        ...
        public Result BroadcastToAll(string message)
        {
            ...
            Playserv.Wrapper.PlayServEvents.Publish(notificationEvent);
        ...
        public Result NotifyGroup(string groupName, string message)
        {
            ...
            Playserv.Wrapper.PlayServEvents.PublishForGroup(groupName, notificationEvent);
        ...
        public Result NotifyUser(string userId, string message)
        {
            ...
            Playserv.Wrapper.PlayServEvents.PublishForUser(userId, notificationEvent);
        ...
        public Result SendMultiLevelNotification(string message, string groupName, string userId)
        {
            ...
            Playserv.Wrapper.PlayServEvents.Publish(broadcastEvent);
            ...
            if (!string.IsNullOrEmpty(groupName))
            {
                ...
                Playserv.Wrapper.PlayServEvents.PublishForGroup(groupName, groupEvent);
            }
            ...
            if (!string.IsNullOrEmpty(userId))
            {
                ...
                Playserv.Wrapper.PlayServEvents.PublishForUser(userId, userEvent);
            }
